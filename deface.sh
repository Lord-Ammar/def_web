...
sleep 0.1;
echo -e $blue'{2} http://thefoundation.co.za'
sleep 0.1;
echo -e $blue'{3} http://techdirect.co.za'
sleep 0.1;
echo -e $blue'{4} http://tieronecapital.co.za'
sleep 0.1;
echo -e $blue'{5} http://totemafrica.com'
sleep 0.1;
echo -e $blue'{6} http://ziady.com'
sleep 0.1;
echo -e $blue'{7} http://whadiz.com'
sleep 0.1;
...
sleep 1;
echo -e $yellow'[=] ########################## [=]'
echo -e $yellow'[+] #subscribe AmmarBN Chanel# [+]'
echo -e $yellow'[+] #      Di Youtube        # [+]'
echo -e $yellow'[=] ########################## [=]'
echo
echo
exit
